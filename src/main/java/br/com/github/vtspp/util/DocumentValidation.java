...
public class DocumentValidation implements Serializable {
     ...
     */
    private static void isValidForReceitaFederal (String document) throws BusinessException {
        ...
        throw new BusinessException ("The number entered is not a valid Cpf or Cnpj for consultation");
    }
